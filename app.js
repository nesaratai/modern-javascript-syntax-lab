...
console.log(`The Array of Numbers Times Two: ${numsTimesTwo}`);
...
console.log(`Seconde Ingredient: ${secondIngredient}`);
// Your code here:
...
// Your code here:
let tastypizza = pizza === 'tasty' ? 'Yum' : 'Yuck'
console.log('Exercise 9:',tastypizza)
